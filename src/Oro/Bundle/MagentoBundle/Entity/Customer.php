...
#[Config(routeName: 'oro_magento_customer_index', routeCreate: 'oro_magento_customer_create', routeView: 'oro_magento_customer_view', defaultValues: ['entity' => ['icon' => 'fa-user'], 'ownership' => ['owner_type' => 'USER', 'owner_field_name' => 'owner', 'owner_column_name' => 'user_owner_id', 'organization_field_name' => 'organization', 'organization_column_name' => 'organization_id'], 'security' => ['type' => 'ACL', 'group_name' => '', 'category' => 'sales_data'], 'form' => ['grid_name' => 'magento-customers-grid'], 'grid' => ['default' => 'magento-customers-grid', 'context' => 'magento-customers-for-context-grid'], 'tag' => ['enabled' => true]])]
...
#[ORM\UniqueConstraint(name: 'magecustomer_oid_cid_unq', columns: ['origin_id', 'channel_id'])]
    ...
    ExtendEntityInterface
{
     ...
     * @var Collection
     */
    #[ORM\OneToMany(targetEntity: 'Oro\Bundle\MagentoBundle\Entity\Cart', mappedBy: 'customer', cascade: ['remove'], orphanRemoval: true)]
    #[ConfigField(defaultValues: ['importexport' => ['excluded' => true]])]
    protected $carts;
     ...
     * @var Collection
     */
    #[ORM\OneToMany(targetEntity: 'Oro\Bundle\MagentoBundle\Entity\Order', mappedBy: 'customer', cascade: ['remove'], orphanRemoval: true)]
    #[ConfigField(defaultValues: ['importexport' => ['excluded' => true]])]
    protected $orders;
     ...
     */
    #[ORM\OneToMany(targetEntity: 'Oro\Bundle\MagentoBundle\Entity\NewsletterSubscriber', mappedBy: 'customer', cascade: ['remove'], orphanRemoval: true)]
    #[ConfigField(defaultValues: ['importexport' => ['excluded' => true]])]
